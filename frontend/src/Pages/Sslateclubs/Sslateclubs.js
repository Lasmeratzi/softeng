...
import './Sslateclubs.css'; // Adjust the path to your CSS file
      ...
      <section className="sbitclubs-main-section">
        <div className="sbitclubs-left-section">
          ...
          <div className="sbitclubs-info-section">
            <h3 className="sbitclubs-info-title">SCHOOL OF SCIENCES, LIBERAL ARTS & TEACHER EDUCATION</h3>
            <p className="sbitclubs-info-body">
            The School of Sciences, Liberal Arts & Teacher Education offers specialized programs in psychology and education, providing students with the knowledge and skills needed for careers in teaching, counseling, and related fields. The school emphasizes both theoretical foundations and practical experience, preparing graduates to make a meaningful impact in education and human services.
            </p>
          </div>
