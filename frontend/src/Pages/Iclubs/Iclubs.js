...
import './Iclubs.css'; // Adjust the path to your CSS file
      ...
      <section className="sbitclubs-main-section">
        <div className="sbitclubs-left-section">
          ...
          <div className="sbitclubs-info-section">
            <h3 className="sbitclubs-info-title">LCCB INTEREST CLUBS</h3>
            <p className="sbitclubs-info-body">
              La Consolacion College Bacolod Interest Clubs
            </p>
          </div>
